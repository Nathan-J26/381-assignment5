...
const Homepage = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://127.0.0.1:5000/testimonials", {
      ...
      .then((data) => {
        setRandomTestimonials(data["testimonials"]);
      })
      .catch((error) => {
        console.error(error);
      });
    ...
    >
      ...
      >
        ...
        <section style={{ marginBottom: "40px" }}>
          <h2 style={{ color: "#004080", marginBottom: "15px" }}>
            About Our LMS
          </h2>
          <p style={{ fontSize: "1.1rem", lineHeight: "1.6" }}>
            Welcome to the Learning Management System designed to empower
            students and educators with cutting-edge online learning tools. Our
            platform offers structured courses, interactive content, and
        ...
        {/* Featured Courses */}
        <section style={{ marginBottom: "40px" }}>
          <h3 style={{ color: "#004080", marginBottom: "20px" }}>
            Featured Courses
          </h3>
          <div
            style={{
          ...
          >
            {featuredCourses.map((course) => (
              ...
              >
                ...
                />
                <h4 style={{ margin: "10px 0", color: "#003366" }}>
                  {course.name}
                </h4>
